<template>
    <bee-page>
        ...
        <div class="bee-content-width">
            ...
            <evidence-table class="mt-24" :order-id="orderId"></evidence-table>
        </div>
...
import EvidenceTable from '@/pageComponents/member/evidence-table.vue';
export default {
    name: 'EvidenceList',
    components: {
        BeeSearch,
        ...
        return {
            ...
            breadcrumbData: [
                ...
                },
                {
                    ...
                    path: `/member/order/${this.$route.params.orderNo}/detail.html`
                },
                {
                    name: '我的凭证'
                }
