...
export default {
    ...
    async asyncData({ params, $api }) {
        const data = await $api.story.getStoryDetails(params.storyId);
        console.log(data);
        return {
            pageData: data,
            breadcrumbData: [
    ...
    mounted() {
        ...
        console.log(this.$store.dispatch('dict/getDict'));
    },
    methods: {
        // 收藏事件
        handleCollect() {
